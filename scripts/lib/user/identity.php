...
function pmssReservedUsernames(): array
{
    ...
    $reserved = array(
        ...
        'admin', 'anacron', 'apache', 'apache2', 'avahi', 'avahi-autoipd', 'bind',
        'clamav', 'chrony', 'colord', 'cron', 'crond', 'crontab', 'crun',
        'cups', 'cupsys', 'dbus', 'dcc',
        'debian-exim', 'debian-deluged', 'dhcp', 'dictd', 'dnsmasq',
        'docker', 'dockerd', 'dovecot', 'elasticsearch', 'fail2ban', 'fetchmail', 'firebird',
        'ftp', 'fuse', 'gdm', 'geoclue', 'git', 'gnome-initial-setup',
        'haldaemon', 'hplilp', 'http', 'httpd', 'identd', 'input',
        'init', 'journal', 'journald', 'jwhois', 'kernoops', 'klog', 'kvm',
        'landscape', 'lightdm', 'logind', 'lpadmin', 'lxc', 'lxd', 'maas',
        'memcache', 'messagebus', 'mongodb', 'monit', 'mosquitto', 'mythtv',
        'nagios', 'named', 'netdev', 'nginx', 'nmbd', 'nscd', 'nslcd', 'ntp',
        'ntpsec', 'openvpn', 'podman', 'polkitd', 'postfix', 'postgres',
        'powerdev', 'proftpd', 'pulse', 'qemu', 'radvd', 'redis', 'render',
        'rpcbind', 'rtkit', 'runc', 'samba', 'saned', 'sbuild', 'scanner',
        'sgx', 'slocate', 'smbd', 'snap_daemon', 'snmpd', 'speech-dispatcher',
        'squid', 'ssh', 'sshd', 'ssl-cert', 'sslwrap', 'sssd', 'statd',
        'stunnel4', 'syslog', 'systemd', 'systemd-coredump',
        'systemd-network', 'systemd-resolve', 'systemd-timesync',
        'tcpdump', 'telnetd', 'tftpd', 'tomcat', 'tomcat8', 'tomcat9',
        'udev', 'udevd', 'unbound', 'usbmux', 'uuidd', 'vagrant', 'varnish',
        'virsh', 'vnstat', 'whoopsie', 'www', 'xen', 'zabbix', '_znc',
