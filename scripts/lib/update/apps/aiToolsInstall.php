...
if (!function_exists('pmssAiToolsNodeMajor')) {
    /**
...
if (!function_exists('pmssAiToolsNodeBinary')) {
    /**
...
if (!function_exists('pmssAiToolsInstallNpmCli')) {
    /**
...
if (!function_exists('pmssAiToolsInstallCodex')) {
    /**
