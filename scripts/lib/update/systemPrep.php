...
pmssRequireRelativeFiles(__DIR__, [
    ...
    'systemPrep/hostEnvironment.php', 'systemPrep/bootDefaults.php', 'systemPrep/sysctlTuning.php', 'systemPrep/systemdSlicesEnsure.php', 'systemPrep/dbusPolicyHardening.php', 'systemPrep/socketTablePrivacy.php',
]);
