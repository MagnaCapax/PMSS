...
class MotdTest extends TestCase
{
    ...
    {
        $this->assertEquals('loaded', trim($this->pmssRunRepoInlinePhpRequire('scripts/motd/Generator.php', 'echo function_exists("getPmssVersion") ? "loaded" : "missing";', $this->pmssTestModeEnv())));
    }
