...
PHP;
        foreach (['field', 'integer', 'device'] as $kind) {
            foreach ([
                ...
                [(string) PHP_INT_MAX, 0, (string) PHP_INT_MAX],
                ['000'.PHP_INT_MAX, 0, '000'.PHP_INT_MAX],
                ['9223372036854775808', 0, $kind === 'field' ? '9223372036854775808' : null],
                [str_repeat('9', 80), 0, $kind === 'field' ? str_repeat('9', 80) : null],
...
PHP;
    ...
    public function testBenchmarkInputGuardsRejectInvalidScalarOptions(): void
    {
        ...
        foreach ([
            ...
            [['--size=0'], $sizeError],
            [['--size=9223372036854775808'], $sizeError],
            [['--size='.str_repeat('9', 80).'P'], $sizeError],
            [['--devices', '--dd-size=bad'], $deviceSizeError],
            [['--devices', '--dd-size=0'], $deviceSizeError],
            [['--devices', '--dd-size=9223372036854775808'], $deviceSizeError],
            [['--runtime=0'], "Error: --runtime must be a positive integer.\n"],
            [['--runtime=15junk'], "Error: --runtime must be a positive integer.\n"],
            [['--runtime=9223372036854775808'], "Error: --runtime must be a positive integer.\n"],
            [['--devices', '--device-runtime=0'], "Error: --device-runtime must be a positive integer.\n"],
            [['--devices', '--device-runtime=9223372036854775808'], "Error: --device-runtime must be a positive integer.\n"],
            [['--idle-util=85percent'], "Error: --idle-util must be a non-negative integer.\n"],
            [['--idle-util=9223372036854775808'], "Error: --idle-util must be a non-negative integer.\n"],
