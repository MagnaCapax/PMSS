...
class UserCgroupCliDryRunTest extends TestCase
{
    ...
    {
        $out = @shell_exec('php scripts/util/userConfigCgroup.php root --dry-run --cpu-weight=300 --io-weight=250 --tasks-max=9000 --memory-high=600 --memory-max=900 --io-read-bw=/dev/sda:5M --io-write-iops=/dev/sda:100');
