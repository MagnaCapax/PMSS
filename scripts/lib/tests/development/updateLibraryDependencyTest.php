...
class UpdateLibraryDependencyTest extends TestCase
{
    ...
    public function testRuntimeBootstrapsKeepOnlyIntentionalFallbackGuards(): void
    {
        ...
        $this->assertRepoFileDependencyCases([
            ...
            ['scripts/lib/update/runtime/commands.php', ["if (!function_exists('runUserStep')) {"], ["if (!function_exists('runStep')) {", "if (!function_exists('aptCmd')) {", "if (!function_exists('pmssBuildCommand')) {", "if (!function_exists('pmssLogStatus')) {", "function_exists('pmssOutputIndicatesForkFailure')"], 'runtime/commands.php should rely on require_once for '],
