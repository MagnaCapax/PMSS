...
class UpdateLibraryDependencyTest extends TestCase
{
    ...
    {
        foreach ([
            ['scripts/lib/userLifecycle.php', ["require_once __DIR__.'/user/log.php';", 'function pmssUserWatchdogEnsureRunning('], ["if (!function_exists('pmssUserLogAllowed')) {"], 'userLifecycle.php should rely on user/log.php for pmssUserLogAllowed()'],
            ...
            ['scripts/cron/checkQbittorrentInstances.php', ["require_once __DIR__.'/../lib/userLifecycle.php';", "pmssUserWatchdogRunEnabledUsers(", "pmssUserWatchdogEnsureRunning(\$thisUser, 'qbittorrent-nox'", "'qbittorrent-nox start requested'"], ['pmssUserLogPath', "\$canUserLog = function_exists('pmssUserLog');"], 'qBittorrent watchdog should use userLifecycle.php as its user logger bootstrap'],
            ['scripts/cron/checkRcloneInstances.php', ["require_once __DIR__.'/../lib/userLifecycle.php';", "pmssUserWatchdogRunEnabledUsers(", "pmssUserWatchdogEnsureRunning(\$thisUser, 'rclone'", "'rclone start requested'"], ['pmssUserLogPath', "\$canUserLog = function_exists('pmssUserLog');"], 'Rclone watchdog should use userLifecycle.php as its user logger bootstrap'],
