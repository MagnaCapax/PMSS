...
class TrafficStatsProcessorEdgeTest extends TrafficTestCase
{
    ...
    {
        [$stub, $paths, $processor] = $this->makeTrafficProcessorStubFixture(false, 'pmss-traffic-edge-');
    ...
    {
        [, $paths, $processor] = $this->makeTrafficProcessorStubFixture(false, 'pmss-traffic-edge-');
