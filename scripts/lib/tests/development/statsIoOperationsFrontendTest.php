...
class StatsIoOperationsFrontendTest extends TestCase
{
    public function testStatsPageFormatsMonthlyIoOperationsSummary(): void
    {
        ...
        $this->pmssAssertRepoFileContainsString('etc/skel/www/statsHelpers.php', 'Past 30 days total I/O operations:');
    }
    ...
    public function testStatsPageBuildsDailyIoOperationsChartFromTotals(): void
    {
        $this->pmssAssertRepoFileContainsAllStrings(
            ...
            ['$snapshot[\'ioDailyOperations\'][] = round($readOps + $writeOps, 2);', "pmssStatsChartDataset('Daily I/O Operations'"]
        );
