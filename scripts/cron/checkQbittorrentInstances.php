...
pmssUserWatchdogRunService('qBittorrent', 'qbittorrentEnable', ['qbittorrent-nox'], 'qbittorrent-nox stopped due to suspension', [
    ['processName' => 'qbittorrent-nox', 'serviceLabel' => 'qBittorrent', 'command' => static function (string $thisUser): string { return "su {$thisUser} -c 'cd ~; nohup qbittorrent-nox -d >> /dev/null 2>&1 &'"; }, 'userLogMessage' => 'qbittorrent-nox start requested'],
