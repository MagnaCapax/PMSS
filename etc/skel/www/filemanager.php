...
//Application Title
define('APP_TITLE', 'Pulsed Media File Manager (TFM)');
...
$max_upload_size_bytes = 6442450944; // 6GiB
...
$is_https = 1; 	// Pulsed Media change -- we run a local reverse proxy, so always force https
